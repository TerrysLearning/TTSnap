...
def set_args():
    ...
    parser.add_argument("--do_valid", action='store_true', default=args_log['second_valid'])
    parser.add_argument("--second_valid", action="store_true", default=args_log['second_valid'])
    ...
    # parser.add_argument("--step_targets_eval", type=str, default=str(config_dict['time_config']['step_targets_eval']))
    ...
    parser.add_argument("--epochs", type=int, default=args_train['epochs'])
    ...
    parser.add_argument("--shift_mean", action="store_true", default=args_train['shift_mean'])
    parser.add_argument("--scale_std", action="store_true", default=args_train['scale_std'])
    ...
    parser.add_argument("--loss_mse_uncertainty_scale", type=float, default=args_train['loss_mse_uncertainty_scale'])
    ...
    parser.add_argument("--loss_repa_scale", type=float, default=args_train['loss_repa_scale'])
    parser.add_argument("--loss_conf_scale", type=float, default=args_train['loss_conf_scale'])
    parser.add_argument("--scheduler_type", type=str, default=args_train['scheduler_type'])
    parser.add_argument("--high_lr_uncertainty", action="store_true", default=args_train['high_lr_uncertainty'])
    ...
    args_train['shift_mean'] = args.shift_mean
    args_train['scale_std'] = args.scale_std
    args_train['bn_before_loss'] = args.bn_before_loss
    args_train['loss_mse_scale'] = args.loss_mse_scale
    args_train['loss_mse_uncertainty_scale'] = args.loss_mse_uncertainty_scale
    args_train['loss_preference_scale'] = args.loss_preference_scale
    args_train['loss_preference_tau'] = args.loss_preference_tau
    args_train['loss_conf_scale'] = args.loss_conf_scale
    args_train['loss_repa_scale'] = args.loss_repa_scale
    args_train['scheduler_type'] = args.scheduler_type
    args_train['high_lr_uncertainty'] = args.high_lr_uncertainty
